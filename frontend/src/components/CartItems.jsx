...
const CartItems = () => {
    ...
    const handleSubmit = () => {
        // Логика обработки купона, если необходимо
        ...
        <section className='max_padd_container pt-28'>
            {purchaseCompleted ? (
                <div className="text-center mt-10">
                    <h2 className="text-2xl font-bold">Вы совершили покупку</h2>
                </div>
            ) : (
                <>
                        ...
                        <div className='flex flex-col gap-10'>
                            ...
                            <div className='flex flex-col gap-10 '>
                                ...
                                <div className='flexBetween pl-5 h-12 bg-primary rounded-full ring-1 ring-slate-900/10'>
                                    ...
                                    />
                                    <button className='btn_dark_rounded' onClick={handleSubmit}>Submit</button>
                                </div>
                            </div>
                        </div>
                    </div>
